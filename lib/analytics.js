 ...
 * tagged-events:  the named goals the page fires — Call Click, and one of Booking
 *                 Request (booking mode) or Enquiry (enquiry mode), never both for
 *                 the same submission. See site/assets/booking.js. */
